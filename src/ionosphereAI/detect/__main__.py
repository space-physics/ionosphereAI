...
python -m ionosphereAI.detect <input file or directory of files> <output directory> <config.ini>

## Examples

### New CCD
python -m ionosphereAI.detect ~/data/2013-04-14-HST0/2013-04-14T07-00-CamSer7196.DMCdata /tmp/2013-04-14 hst0.ini -f 362000 365000 -k10
farneback works very well.
HS very well too, alpha=10, iter=1 or 2 (iter not critical)

### Old CCD
python -m ionosphereAI.detect ~/data/2011-03-01/optical/2011-03-01T100608.000.h5  ~/data/2011-03-01/optical/cv 2011.ini


### SPOOL FILES DIRECTLY
(poor choice, should use index.h5 since the spool file names are NOT time monotonic!)

    python -m ionosphereAI.detect ~/data/testdmc  /tmp dmc2017.ini

### FITS FILES

    python -m ionosphereAI.detect ~/data/DMC2015-10/2015-10-31/ /tmp/2015-10-31 dmc-fits.ini -k 30

### TIFF FILES

    python -m ionosphereAI.detect ~/data/DMC2015-10/2015-10-31/ /tmp/2015-10-31 dmc-tiff.ini -k 30
...
1. find time order of spool files, stores in index.h5 by filename
    ...
    python -m dmcutils.FileTick ~/data/DMC2015-10/2015-10-21_1/
2. detect aurora  (-k 10 is max, 30 is too much)

    python -m ionosphereAI.detect ~/data/DMC2015-10/2015-10-21_1/index.h5 /tmp/2015-10-21 dmc.ini

    python -m ionosphereAI.detect ~/H/neo2012-12-25/spool_5/index.h5 ~/Dropbox/DMC/2012-12-25 dmc2012.ini

### 2017 files

    python -m ionosphereAI.detect ~/data/archive.27Mar2017/2017-03-27/spool/index.h5 ~/data/archive.27Mar2017/dmc2017.ini -v

    python -m ionosphereAI.detect ~/data/2017-04-27/spool/index.h5 ~/data/2017-04-27 dmc2017.ini -k10
...
3. python -m ionosphereAI.detect index.h5 (loads the files you specified in step 2 in time order)
